...
router.get('/:symbol', function(req, res, next) {
  ...
  const request = https.get('https://www.alphavantage.co/query?function=STOCH&symbol='+name+'&interval=daily&time_period=10&series_type=close&apikey=B1FXC27WA1HL6WAO&outputsize=full',function(response) {
    var size = 0;
    var chunks = [];
