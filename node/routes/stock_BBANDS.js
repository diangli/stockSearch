...
router.get('/:symbol', function(req, res, next) {
  ...
  const request = https.get('https://www.alphavantage.co/query?function=BBANDS&symbol='+name+'&interval=daily&time_period=5&series_type=close&apikey=B1FXC27WA1HL6WAO&outputsize=full&nbdevup=3&nbdevdn=3',function(response) {
    var size = 0;
    var chunks = [];
